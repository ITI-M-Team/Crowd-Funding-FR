...
function ProfilePage() {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://localhost:8000/api/extra-info/", {
        headers: { Authorization: `Token ${token}` },
      })
  ...
  const { profile_picture, first_name, last_name, email, mobile_phone, projects, donations } = userData;
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <main className="w-3/4 p-8">
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div><strong>Mobile:</strong> {mobile_phone}</div>
        ...
        <div ><p>
              ...
              {extraInfo.facebook_account ? (
                <a
                  href={extraInfo.facebook_account}
                  target="_blank"
